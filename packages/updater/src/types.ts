import type { GenericServerOptions, ProgressInfo, UpdateInfo } from 'builder-util-runtime'
...
export interface BootUpdateDownloaded extends UpdateDownloadedEvent, BootUpdateInfo {}
